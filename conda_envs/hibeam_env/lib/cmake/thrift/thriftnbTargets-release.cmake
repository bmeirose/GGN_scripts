...
set_target_properties(thriftnb::thriftnb PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libthriftnb.so.0.21.0"
  IMPORTED_SONAME_RELEASE "libthriftnb.so.0.21.0"
  )

list(APPEND _cmake_import_check_targets thriftnb::thriftnb )
list(APPEND _cmake_import_check_files_for_thriftnb::thriftnb "${_IMPORT_PREFIX}/lib/libthriftnb.so.0.21.0" )
