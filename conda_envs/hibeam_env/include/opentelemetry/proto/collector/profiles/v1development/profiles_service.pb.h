...
/* @@protoc_insertion_point(class_definition:opentelemetry.proto.collector.profiles.v1development.ExportProfilesPartialSuccess) */ {
 public:
  ...
  void operator delete(ExportProfilesPartialSuccess* msg, std::destroying_delete_t) {
    SharedDtor(*msg);
  ...
  ExportProfilesPartialSuccess* New(::google::protobuf::Arena* arena = nullptr) const {
...
/* @@protoc_insertion_point(class_definition:opentelemetry.proto.collector.profiles.v1development.ExportProfilesServiceResponse) */ {
 public:
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
  void operator delete(ExportProfilesServiceResponse* msg, std::destroying_delete_t) {
    SharedDtor(*msg);
  ...
  ExportProfilesServiceResponse* New(::google::protobuf::Arena* arena = nullptr) const {
...
/* @@protoc_insertion_point(class_definition:opentelemetry.proto.collector.profiles.v1development.ExportProfilesServiceRequest) */ {
 public:
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
  void operator delete(ExportProfilesServiceRequest* msg, std::destroying_delete_t) {
    SharedDtor(*msg);
  ...
  ExportProfilesServiceRequest* New(::google::protobuf::Arena* arena = nullptr) const {
