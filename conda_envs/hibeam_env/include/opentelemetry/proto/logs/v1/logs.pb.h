...
template <typename Arg_, typename... Args_>
inline PROTOBUF_ALWAYS_INLINE void LogRecord::set_event_name(Arg_&& arg,
                                                     Args_... args) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
...
inline std::string* LogRecord::mutable_event_name() ABSL_ATTRIBUTE_LIFETIME_BOUND {
...
inline void LogRecord::set_allocated_event_name(std::string* value) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
